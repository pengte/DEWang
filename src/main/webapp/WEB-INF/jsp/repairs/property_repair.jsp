...
<head>
    ...
    <link rel="stylesheet" href="../../css/property_repair.css">
</head>
<body>
<!--头部-->
    <header>
...
<!--页面左侧-->
    ...
    <div class="con"  style="border:1px solid #ccc;margin-top: 15px;margin-left: 220px;margin-right: 10px;">
        <div class="con_left">
            ...
            <div class="con_box">
                <div class="bk_head">
                    <em><img src="../../images/jx_02.png" alt=""></em><span class="txs"style="background-color:#beebff ">全部报修</span>
                </div>
                <ul class="bk_list">
                    <li>
                        <em><img src="../../images/bk_03.png" alt=""></em><span class="txs">待受理报修</span>
                    </li>
                    <li>
                        <em><img src="../../images/bk_03.png" alt=""></em><span class="txs">正在处理报修</span>
                    </li>
                    <li>
                        <em><img src="../../images/bk_03.png" alt=""></em><span class="txs">处理结束报修</span>
                    </li>
                    <li>
                        <em><img src="../../images/bk_03.png" alt=""></em><span class="txs">已完成报修</span>
                    </li>
                    <li>
                        <em><img src="../../images/zz_02.png" alt=""></em><span class="txs">无效报修</span>
                    </li>
                </ul>
            </div>
        </div>
        <div class="con_right">
            <div class="con_right_head">
                ...
                <input class="cr_ipt2" type="submit" style="background-color:#00a0e9 " value="模糊查询">
                <a href="property_repair_adds.jsp" class="cr_a">新增报修</a>
                <a href="property_charge_repair.jsp" class="cr_a" id="cr_a2">收费项目维护</a>
                <a href="property_repair_alerts.jsp" class="cr_a">短信提醒</a>
            </div>
            <div>
                <div class="con_right_box" style="display:block;">
                    <div class="cr_con">
                        <div class="crc_head">
                            <em><img src="../../images/qb.png" alt=""></em>全部报修 列表
                        </div>
                        <div>
                ...
                <div class="con_right_box">
                    <div class="cr_con">
                        <div class="crc_head">
                            <em><img src="../../images/qb.png" alt=""></em>待处理报修 列表
                        </div>
                        <div>
                            <table class="cr_table">
                                <tr class="t_head">
                ...
                <div class="con_right_box">
                    <div class="cr_con">
                        <div class="crc_head">
                            <em><img src="../../images/qb.png" alt=""></em>正在处理报修 列表
                        </div>
                        <div>
                            <table class="cr_table">
                                <tr class="t_head">
                ...
                <div class="con_right_box">
                    <div class="cr_con">
                        <div class="crc_head">
                            <em><img src="../../images/qb.png" alt=""></em>处理结束报修 列表
                        </div>
                        <div>
                            <table class="cr_table">
                                <tr class="t_head">
                ...
                <div class="con_right_box">
                    <div class="cr_con">
                        <div class="crc_head">
                            <em><img src="../../images/qb.png" alt=""></em>已完成报修 列表
                        </div>
                        <div>
                            <table class="cr_table">
                                <tr class="t_head">
                ...
                <div class="con_right_box">
                    <div class="cr_con">
                        <div class="crc_head">
                            <em><img src="../../images/qb.png" alt=""></em>无效报修 列表
                        </div>
                        <div>
                            <table class="cr_table">
                                <tr class="t_head">
