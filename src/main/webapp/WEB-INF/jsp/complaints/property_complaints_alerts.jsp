...
<head>
    ...
    <link rel="stylesheet" href="../../css/property_repair_alerts.css">
</head>
<body>
<!--头部-->
    <header>
...
<!--页面左侧-->
    ...
    <div class="con_head" id="con_head">
        <em><img src="../../images/wy.png" alt=""></em><a href="#">物业管理</a><span>></span><a href="#">投诉</a><span>></span><a href="#">通知设置</a>
    </div>
    <div class="con"  style="border:1px solid #ccc;margin-top: 15px;margin-left: 220px;margin-right: 10px;height: 500px;">
        <div class="con_left">
            <div class="con_left_head">
                <em><img src="../../images/y_sz.png" alt=""></em>投诉通知设置
            </div>
            <div class="con_box">
                <div class="cb_alert">
                    <p>提示！</p>
                    <div>
                        小区开启短信通知后，业主的投诉将会已短信的形式通知到”短信接收人“的手机上。
                    </div>
                </div>
                <div class="figs" style="margin-top: 20px">
                    <span>是否开启短信提醒：</span>
                    <select name="">
                        <option value="kaiqi">开启</option>
                        <option value="guanbi">关闭</option>
                    </select>
                </div>
                <div class="figs">
                    <span>短信接收人：</span>
                    <select name="">
                        <option value="kaiqi">请选择</option>
                        <option value="guanbi">Admin - 系统管理员</option>
                    </select>
                </div>
                <div class="figs">
                    <span>短信接收手机号码：</span>
                    <input type="text" placeholder="短信接收手机号码" class="cr_ipt1">
                </div>
                <div class="figs">
                    <span>短信接收人二：</span>
                    <select name="">
                ...
                <div class="btn">
                    ...
                    <a href="property_complaints.jsp" class="btn_a" style="background-color: #ff3816">返回</a>
                </div>
            </div>
        </div>
    </div>
