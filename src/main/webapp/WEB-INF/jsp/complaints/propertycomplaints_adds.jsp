...
<!--页面左侧-->
    ...
    <div class="con"  style="border:1px solid #ccc;margin-top: 15px;margin-left: 220px;margin-right: 10px;height: 420px;">
        <div class="con_left">
            <div class="con_left_head">
                <em><img src="../../images/y_ad.png" alt=""></em>新增投诉信息
            </div>
            <div class="con_box">
                <form action="">
                    <div class="figs">
                        <span><em>*</em>投诉房号缩写：</span>
                        <input type="text" placeholder="报修房号" class="cr_ipt1">
                    </div>
                    <div class="figs">
                        <span><em>*</em>投诉人姓名：</span>
                        <input type="text" placeholder="报修人姓名" style="width: 200px;" class="cr_ipt1">
                    </div>
                    <div class="figs">
                        <span><em>*</em>投诉人电话：</span>
                    ...
                    <div class="figs" style="overflow: hidden;height: auto;padding: 10px 0 10px 60px;">
                        <span style="float: left"><em>*</em>投诉内容：</span>
