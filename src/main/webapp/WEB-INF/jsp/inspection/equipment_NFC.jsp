...
<div class="left">
    <div class="left_list" id="left_list2">
        ...
        <div class="left_slide" style="display:block">
            ...
            <span style="background-color:#ff3816"><a href="equipment_NFC.jsp">NFC订单</a></span>
        </div>
...
<div class="con_head" id="con_head">
    <em><img src="../../images/Hshebeixunjian.png" alt=""></em><a href="#">设施巡检</a><span>></span><a href="#">巡检设施NFC订单</a>
</div>
