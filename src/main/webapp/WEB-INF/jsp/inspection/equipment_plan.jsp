...
<div class="con_head" id="con_head">
    <em><img src="../../images/Hshebeixunjian.png" alt=""></em><a href="#">设施巡检</a><span>></span><a href="#">巡检任务推送计划</a>
</div>
<div class="con" style="margin-top:0;margin-left:200px;padding-top:15px;">
    ...
    <div class="equipment_list">
        <div class="equipment_list_title chairfix">
            ...
            <span>巡检任务推送计划列表</span>
            <a href="equipment_plan_add.jsp">新增计划</a>
            <a href="equipment_plan_divide.jsp" style="width:106px;">巡检设施分组</a>
        </div>
        <div>
            <ul class="equipment_list_mess equipment_managed_mess chairfix">
                <li style="width:15%">巡检计划名称</li>
                <li>所属小区</li>
                <li>推送周期/有效期</li>
                <li>推送信息</li>
                <li>设施分组</li>
