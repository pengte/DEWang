...
<div class="con_head" id="con_head">
    <em><img src="../../images/Hshebeixunjian.png" alt=""></em><a href="#">设施巡检</a><span>></span><a href="#">巡检任务推送计划</a><span>></span><a href="#">巡检设施工作</a>
</div>
<div class="con" style="margin-top:0;margin-left:200px;padding-top:15px;">
    ...
    <div class="equipment_list">
        <div class="equipment_list_title chairfix">
            ...
            <span>巡检设施分组列表</span>
            <a href="equipment_plan_divide_add.jsp">新增分组</a>
            <a href="equipment_plan.jsp" style="width:106px;">返回推送计划</a>
        </div>
        <div>
            <ul class="equipment_list_mess equipment_plan_mess chairfix">
                <li>分组名称</li>
                <li>所属小区</li>
                <li  style="width:20%">设施列表</li>
                <li>最后操作日期</li>
                <li>操作人</li>
        ...
        <ul class="equipment_list_message">
            <li>
                <ul class="equipment_list_mess equipment_plan_mess chairfix">
                    ...
                    <li><span>xxxx</span></li>
                    <li><span>xxxx</span></li>
                    <li  style="width:20%"><a href="" class="equipment_list_xiuG">修改</a></li>
                </ul>
            </li>
        </ul>
