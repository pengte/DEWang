...
<div class="con_head" id="con_head">
    <em><img src="../../images/Hxitong.png" alt=""></em><a href="#">系统管理</a><span>></span><a href="#">角色、权限设定</a><span>></span><a href="#">角色设定</a>
</div>
<div class="con" style="margin-top:0;margin-left:200px;padding-top:15px;">
    <div class="sysPerOne_bar">
        <p><a href="systems_permission.jsp">返回</a></p>
    </div>
    <div class="equipment_list">
        <div class="equipment_list_title sysPerOne_title chairfix">
            <div><img src="../../images/H_ViewGallery.png" alt=""></div>
            <span><em>郑州市德旺物业管理有限公司</em>角色设置</span>
            <a href="systems_permissionOne_add.jsp">新增角色</a>
        </div>
        <div>
            <ul class="equipment_list_mess sysPerOne_mess chairfix">
                <li>角色名称</li>
                <li>所属小区/公司</li>
                <li>角色人员</li>
                <li>角色权限</li>
        ...
        <ul class="equipment_list_message sysPer_list_message">
            <li>
                <ul class="equipment_list_mess sysPerOne_mess chairfix">
