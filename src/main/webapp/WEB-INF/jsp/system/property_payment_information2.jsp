    ...
    <div class="con" style="margin-top: 0;margin-left: 200px">
        <div style="width: 100%;height: 1000px;">
            <div class="con_box" style="height: auto;">
                ...
                <div class="con_box_con" style="box-sizing: border-box;padding: 15px;text-align: left;height: 390px;">
                    <div class="cb_con_div1">
                        <span><em>*</em>下载协议</span><a href="#" style="color: #ff3816;font-size: 13px">下载《金牌管家物业缴费商户合作协议》</a>
                    </div>
                    <div class="cb_con_div1" style="height: 220px;">
                        <span style="float: left"><em>*</em>上传协议</span>
                        <div style="float: left;">
                            ...
                            <div>
                                ...
                                <a href="#" style="color: #666;font-size: 12px;">请上传rar压缩后的文件</a>
                            </div>
                        </div>
                    </div>
                    <div class="cb_con_div1" style="height: 100px;box-sizing: border-box;padding-top: 40px;border-bottom: none;">
                        <a href="property_payment_information.jsp" class="cb_a">下一步</a>
                    </div>
                </div>
            </div>
        </div>
