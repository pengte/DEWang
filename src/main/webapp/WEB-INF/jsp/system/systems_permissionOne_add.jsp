...
<div class="con" style="margin-top:0;margin-left:200px;overflow:hidden">
    <div class="equipment_index_biao">
        <div class="equipment_index_top sysPerOngAdd_top chairFix">
            ...
            <p><em>郑州市德旺物业管理有限公司</em>新增角色信息</p>
        </div>
        <form action="" class="theForm equipmetn_theForm">
            ...
            <div>
                ...
                <table class="theTable" border="1px solid">
                    ...
                    <tr>
                        <td rowspan="4"><input type="checkbox" class="serviceAddAll">增值服务</td>
                        <td><input type="checkbox" class="serviceAdd">生活黄页</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" class="serviceAdd">社区服务</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" class="serviceAdd">房屋租赁</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" class="serviceAdd">活动发布</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" class="insideManaAll">内部管理</td>
                        <td><input type="checkbox" class="insideMana">内部通知</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td rowspan="9"><input type="checkbox" class="systemsManasAll">系统管理</td>
                        <td><input type="checkbox" class="systemsManas">物业公司</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" class="systemsManas">支付信息</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" class="systemsManas">人员群组</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" class="systemsManas">物业管理器</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" class="systemsManas">小区管理</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" class="systemsManas">房屋管理</td>
                        <td></td>
                    </tr>
                    <tr>
...
<script>
    ...
    checkChoose(".serviceAddAll",".serviceAdd");
    checkChoose(".insideManaAll",".insideMana");
