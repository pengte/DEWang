...
<div class="con_head" id="con_head">
    <em><img src="../../images/Hxitong.png" alt=""></em><a href="#">系统管理</a><span>></span><a href="#">角色、权限设定</a>
</div>
<div class="con" style="margin-top:0;margin-left:200px;padding-top:15px;">
    <div class="equipment_list">
        ...
        <div>
            <ul class="equipment_list_mess sysPer_mess chairfix">
                <li>物业公司名称</li>
                <li>操作</li>
            </ul>
        </div>
        <ul class="equipment_list_message sysPer_list_message">
            <li>
                <ul class="equipment_list_mess sysPer_mess chairfix">
                    ...
                    <li><span><a href="systems_permissionOne.jsp">查看/设置角色</a></span></li>
                </ul>
            </li>
        </ul>
    </div>
    <div class="equipment_list">
        ...
        <ul class="equipment_list_message sysPer_list_message">
            <li>
                <ul class="equipment_list_mess sysPer_mess chairfix">
                    <li><span>xxxx</span></li>
                    <li><span><a href="systems_permissionTwo.jsp">查看/设置角色</a></span></li>
                </ul>
            </li>
        </ul>
    </div>
