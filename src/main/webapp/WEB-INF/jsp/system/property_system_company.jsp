...
<div class="left">
    ...
    <div class="con" style="margin-left: 200px;margin-top: 60px;">
            <div style="width: 100%;overflow: hidden;">
                <div class="box1">
                    <div class="box_div">
                        <span><img src="../../images/y_logo.png" alt=""></span>
                        <div>
                            郑州市德旺物业管理有限公司
                            <em class="wrz">未认证</em>
                        </div>
                ...
                <div class="box2">
                    <div class="box2_left">
                        <p style="font-size: 20px;color: #666;">物业公司基本信息</p>
                        <div>公司名称</div>
                        <div>
                            公司名称简称
                        </div>
                    ...
                    <div class="box2_right">
                        <ul>
                            <li>郑州市德旺物业管理有限公司
                                <a href="property_system_company2.jsp">编辑</a>
                            </li>
                            <li></li>
                            <li></li>
                            <li></li>
                ...
                <div class="box2">
                    <div class="box2_left">
                        <p style="font-size: 20px;color: #666;">联系人信息</p>
                        <div>联系人</div>
                        <div>
                            联系电话
                        </div>
