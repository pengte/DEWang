        ...
        <div style="width: 100%;height: 900px;">
            <div class="con_box">
                ...
                <div class="con_box_con">
                    ...
                    <div class="cbc_left">
                        <div class="cbcl_div1">已是银联商户 <img class="cbc_img" src="../../images/y_xsj.png" alt=""></div>
                        <div class="cbcl_div2">
                            <div class="cbc_t">开通<br>线上支付</div>
                            <div class="cbc_bg"></div>
                        </div>
                        <div class="cbcl_div3">
                                》<em>开通线上支付</em><br>业主可以线上缴费物业费
                        </div>
                        <a href="property_payment_information1.jsp" id="c_left"></a>
                    </div>
                    <div class="cbc_right">
                        <div class="cbcl_div1">未是银联商户 <img class="cbc_img" src="../../images/y_xsj.png" alt=""></div>
                        <div class="cbcl_div2" style="background: url('../../images/imgChose2.jpg') 0 0 no-repeat;">
                            <div class="cbc_t">申请/开通<br>线上支付</div>
                            <div class="cbc_bg"></div>
                        </div>
                        <div class="cbcl_div3">
                            》<em>申请开通线上支付</em><br>先申请成为银联商户，然后开通线上支付
                        </div>
                        <a href="property_payment_information2.jsp" id="c_left2"></a>
                    </div>
                </div>
            </div>
        </div>
