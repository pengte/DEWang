...
<!--页面左侧-->
    <div class="left">
        <div class="left_list" id="left_list2">
                ...
                <div class="left_slide" style="display: block">
                    ...
                    <span style="background-color: #ff3816"><a href="property_Accounting_management_99.jsp">算费管理</a></span>
    ...
    <div class="con_head" id="con_head">
        <em><img src="../../images/wy.png" alt=""></em><a href="#">前欠费用录入</a>
    </div>
    <div class="con"  style="margin-top: 15px;margin-left: 220px;margin-right: 10px;">
        <div class="con_left">
            <div class="con_left_head">
                ...
                <a href="property_cost_management.jsp" class="ch_a">返回</a>
            </div>
            <div class="con_box">
