        ...
        <div>
            <div class="con_right" style="display: block">
                <div class="con_right_head">
                    <em><img src="../../images/qb.png" alt=""></em>修改流水号
                    <!--<a href="#">设置</a>-->
                </div>
                <div class="con_right_box" style="border-bottom: 1px solid #ddd;">
                    <div class="figs">
                        <span>单据类型：</span><input class="cr_ipt1" type="text" value="临时交费收款收据" disabled style="cursor: not-allowed">
                    </div>
                    <div class="figs">
                        <span><em>*</em>单据前缀：</span><input class="cr_ipt1" type="text" value="JPGJ-L">
                    </div>
                    <div class="figs">
                        <span><em>*</em>流水号长度：</span><input class="cr_ipt1" type="text" value="10">
                    </div>
                    <div class="figs">
                        <span><em>*</em>当前流水号：</span><input class="cr_ipt1" type="text" value="0">
                    </div>
                    <div class="figs">
                        <span>效果：</span><input type="text" class="cr_ipt1" value="JPGJ-L0000000000" disabled style="cursor: not-allowed">
                    </div>
                    <div class="btn">
