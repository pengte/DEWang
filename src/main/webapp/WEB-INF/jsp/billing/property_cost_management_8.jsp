    ...
    <div class="con"  style="border:1px solid #ccc;margin-top: 15px;margin-left: 220px;margin-right: 10px;height: 460px;">
        <div class="con_left">
            <div class="con_left_head">
                <em><img src="../../images/qb.png" alt=""></em>统扣
            </div>
            <div class="con_box">
                <form action="">
                    <div class="figs">
                        <span><em>*</em>扣费期间：</span>
                        <input type="date" style="width: 150px;">
                    </div>
                    <div class="figs">
                        <span><em>*</em>零钱是否参与统扣：</span>
                        <select name="">
                            <option value="kaiqi">不参与</option>
                            <option value="guanbi">参与</option>
                        </select>
                    </div>
                    <div class="figs">
                        <span>凭证号：</span>
                    ...
                    <div class="figs" style="overflow: hidden;height: auto;padding: 10px 0 10px 60px;">
                        ...
                        <textarea name="" id="" style="float: left;width: 410px;height: 110px;font-size: 16px;color: #666;padding: 5px;border:1px solid #ddd;" class="cr_ipt1" placeholder="说明"></textarea>
                    </div>
                    <div class="btn">
