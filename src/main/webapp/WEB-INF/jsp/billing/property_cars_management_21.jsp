...
<!--页面左侧-->
    ...
    <div class="con_head" id="con_head">
        <em><img src="../../images/wy.png" alt=""></em><a href="#">车辆管理</a><span>></span><a href="#">创建停车费类型</a>
    </div>
    <div class="con"  style="margin-top: 15px;margin-left: 220px;margin-right: 10px;">
        <div class="con_left" style="border:1px solid #ddd;">
            <div class="con_left_head">
                <em><img src="../../images/y_ad.png" alt=""></em>创建停车费类型
            </div>
            <div class="con_box">
                <form action="">
                    <div class="figs">
                    ...
                    <div class="figs">
                        <span><em>*</em>价格：</span>
                        <input type="text" placeholder="支持两位小数" style="width: 300px;" class="cr_ipt1">
                    </div>
                    <div class="figs" style="overflow: hidden;height: auto;padding: 10px 0 10px 60px;">
                        <span style="float: left"><em>*</em>说明：</span>
                        <textarea name="" id="" style="float: left;width: 310px;height: 60px;font-size: 16px;color: #666;padding: 5px;border:1px solid #ddd;" class="cr_ipt1"></textarea>
                    </div>
                    <div class="btn">
                        <button style="margin-left: 200px;">保存</button>
                        <a href="property_cars_management_2.jsp" class="btn_a" style="background-color: #ff3816">关闭</a>
                    </div>
                </form>
            </div>
        </div>
