        ...
        <div>
            <div class="con_right" style="display: block">
                <div class="con_right_head">
                    <em><img src="../../images/qb.png" alt=""></em>新建收费规则 <strong style="color: #ff3816;">( “欠费项” 欠费总额 大于 “欠费总额” 则 “交费项” 最多交费 “最多交费额” )</strong>
                    <!--<a href="#">设置</a>-->
                </div>
                <div class="con_right_box" style="border-bottom: 1px solid #ddd;">
                    <div class="figs">
                        <span><em>*</em>欠费项：</span><a href="property_Charge_Package2.jsp">请先添加收费项</a>
                    </div>
                    <div class="figs">
                        <span><em>*</em>欠费总额/元：</span><input class="cr_ipt1" type="text" placeholder="欠费总额/元">
                    </div>
                    <div class="figs">
                        <span><em>*</em>交费项：</span><a href="property_Charge_Package2.jsp">请先添加收费项</a>
                    </div>
                    <div class="figs">
                        <span><em>*</em>最多交费额/元：</span><input class="cr_ipt1" type="text" placeholder="最多交费额/元">
                    </div>
                    <div class="btn">
