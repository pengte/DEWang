...
<!--页面左侧-->
    <div class="left">
        <div class="left_list" id="left_list2">
                ...
                <div class="left_slide" style="display: block">
                    ...
                    <span style="background-color: #ff3816"><a href="property_Accounting_management_77.jsp">套户账户</a></span>
                </div>
    ...
    <div class="con_head" id="con_head">
        <em><img src="../../images/wy.png" alt=""></em><a href="#">套户账户</a>
    </div>
    <div class="con"  style="margin-top: 15px;margin-left: 220px;margin-right: 10px;">
        <div class="con_left">
            <div class="con_left_head">
                ...
                <a href="property_Accounting_management.jsp" class="ch_a">去收费</a>
            </div>
            <div class="con_box">
        ...
        <div class="con_right" style="background-color: #f0f0f0;border:none">
            请选择套户！
        </div>
    </div>
