...
<!--页面左侧-->
    <div class="left">
        <div class="left_list" id="left_list2">
                ...
                <div class="left_slide" style="display: block">
                    ...
                    <span style="background-color: #ff3816"><a href="property_cost_binding.jsp">套餐绑定</a></span>
    ...
    <div class="con_head" id="con_head">
        <em><img src="../../images/wy.png" alt=""></em><a href="#">费用设置</a><span>></span><a href="#">收费项目分配</a>
    </div>
    <div class="con"  style="margin-top: 15px;margin-left: 220px;margin-right: 10px;">
        <div class="con_left">
            <div class="con_left_head">
                <em><img src="../../images/xql.png" alt=""></em>收费项目信息
            </div>
            <div class="con_box">
                <div class="bk_head" style="margin-top: 10px">
                    <em><img src="../../images/jx_02.png" alt=""></em><span class="txs"><strong><img src="../../images/y_x.png" alt=""></strong>美景天城</span>
                </div>
                <ul class="bk_list">
                    <li>
                        <em><img src="../../images/bk_03.png" alt=""></em><span class="txs"><strong><img src="../../images/y_x.png" alt=""></strong>1栋</span>
                    </li>
                    <li>
                        <em><img src="../../images/bk_03.png" alt=""></em><span class="txs"><strong><img src="../../images/y_x.png" alt=""></strong>2栋</span>
                    </li>
                    <li>
                        <em><img src="../../images/zz_02.png" alt=""></em><span class="txs"><strong><img src="../../images/y_x.png" alt=""></strong>3栋</span>
                    </li>
                </ul>
            </div>
        </div>
